...
If you are planning to contribute content that involves paid services, please review our [Guidance for submissions involving paid services](https://github.com/Altinn/Kitt_KI_Hub/discussions).
...
```json
{
  ...
  "version": "1.0.0",
  "keywords": [],
  "author": { "name": "DigDir KI HUB Community" },
