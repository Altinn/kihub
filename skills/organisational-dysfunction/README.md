...
Diagnose recurring organisational and team dysfunctions through **open sociotechnical systems theory** (the DP1 top-down vs DP2 self-managing distinction). The router `SKILL.md` carries the shared lens and indexes 97 named dysfunctions; each `references/NN-*.md` gives how it shows up, the sociotechnical diagnosis, and concrete remedies.
...
### 0.23.0 — 2026-09-22
- Catch-up propagation of five upstream entries (92 → 97 dysfunctions): `#93` **Innovation theatre**, `#94` **The efficiency drive**, `#95` **The talent myth**, `#96` **Nobody wants to own this**, and `#97` **The org chart nobody uses**. Router `SKILL.md` synced with upstream.

### 0.22.0 — 2026-09-14
- Catch-up propagation of three upstream entries (89 → 92 dysfunctions): `#90` **Somebody has to chase it**, `#91` **Endless alignment meetings**, and `#92` **The change they stopped believing in**. Router `SKILL.md` synced with upstream.

### 0.21.0 — 2026-09-09
- Added `#89` **We need a resource** (88 → 89 dysfunctions). Router `SKILL.md` synced with upstream.

### 0.20.0 — 2026-09-08
- Catch-up propagation of four upstream entries (84 → 88 dysfunctions): `#85` **The enterprise architect**, `#86` **Removing management**, `#87` **It took an outsider to say it**, and `#88` **The gates they removed**. Router `SKILL.md` synced with upstream.

### 0.19.0 — 2026-09-02
- Catch-up propagation of five upstream entries (79 → 84 dysfunctions): `#80` **When the glue leaves**, `#81` **Loose in name only**, `#82` **The wrong people in the room**, `#83` **The wellness programme**, and `#84` **Deskilled by AI**. Router `SKILL.md` synced with upstream.

### 0.18.0 — 2026-08-26
- Added `#79` **The adaptation plan nobody owns** (78 → 79 dysfunctions).

### 0.17.0 — 2026-08-25
- Added `#78` **Back to the office** (77 → 78 dysfunctions).

### 0.16.0 — 2026-08-23
- Added `#77` **Becoming Teal** (76 → 77 dysfunctions).
...
### 0.13.0 — 2026-08-19
- Added `#74` **Matrices** (73 → 74 dysfunctions).

### 0.12.0 — 2026-08-18
- Added `#73` **What the war room proves** (72 → 73 dysfunctions).

### 0.11.0 — 2026-08-16
- Added `#71` **The values on the wall** and `#72` **Hired from above** (70 → 72 dysfunctions).

### 0.10.0 — 2026-08-13
- Added `#70` **The blind decision** (69 → 70 dysfunctions).

### 0.9.0 — 2026-08-12
- Added `#69` **Playing politics** (68 → 69 dysfunctions).
