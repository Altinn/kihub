...
Use a custom agent from the repository [`agents/terraform-azure-implement.agent.md`](https://github.com/Altinn/kihub/blob/main/agents/terraform-azure-implement.agent.md) (click through to see full definition).
